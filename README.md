...
The repository-native web product migration is complete and this repository is the canonical implementation location for v0.30 / engine 0.20.0.

- **Historical validated baseline:** prototype v0.28.2 / engine 0.18.2
- **Canonical repository engine:** v0.30.0 / engine 0.20.0
